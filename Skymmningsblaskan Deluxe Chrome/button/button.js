...
document.addEventListener("click", function(e) {
  if (e.target.classList.contains("play")) {
	...
	var executing = chrome.tabs.executeScript({file:"/contentscripts/skymmningsblaskandeluxe.js"});
	...
	var executing = chrome.tabs.executeScript({file:"/contentscripts/removetext.js"});
	executing.then(succ,reportError);
